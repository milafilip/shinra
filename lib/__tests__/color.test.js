...
describe('color', () => {
  ...
  test('should be happy with null', () => {
    expect(Color.getTerminalColor(null)).toEqual('white')
  })

  test('should be happy with input which is not a hex value', () => {
    expect(Color.getTerminalColor("Not hex color")).toEqual('blue')
  })
  test('should be happy with input which is not a hex value', () => {
    expect(Color.getTerminalColor("Not hex color 1")).toEqual('grey')
  })
  test('should be happy with input which is not a hex value', () => {
    expect(Color.getTerminalColor("Not hex color 2")).toEqual('magenta')
  })
})
