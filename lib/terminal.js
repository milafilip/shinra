...
class Terminal {
  ...
  start (prompt, onUserInput) {
    const startHelper = (msg, prompt, onUserInput) => {
      onUserInput(msg)
      this.rl.question(prompt, (msg) => {
        startHelper(msg, prompt, onUserInput)
      })
    }
    this.rl.question(prompt, (msg) => startHelper(msg, prompt, onUserInput))
    return this
  }
